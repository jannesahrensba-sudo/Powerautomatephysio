# Betroffene Formeln, Steuerelement für Steuerelement (DE)
...
If(
    ...
    // Zu knapp fuer eine Behandlungsdoku.
    // Sperrt, statt nur zu warnen - die Doku
    // ist ein Rechtsdokument nach § 630f BGB.
    Len(Trim(txtMassnahmen.Text)) < minZeichen Or Len(Trim(txtReaktion.Text)) < minZeichen;
    Set(gblMeldung;
        "Bitte etwas ausführlicher: mindestens " & minZeichen &
        " Zeichen je Pflichtfeld. Die Bausteinliste hilft.");;
    Set(gblMeldungArt; "Warnung");
    ...
    If(
        ...
        // Puffer zuerst leeren, sonst stellt
        // Reset den alten Text aus Default
        // wieder her.
        Set(gblTxtM; "");; Set(gblTxtR; "");;
        Set(gblReset; true);; Set(gblReset; false);;
        Set(gblMeldung;
