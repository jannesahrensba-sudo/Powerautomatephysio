# Zusaetzlich zu setzende App- und Bildschirmeigenschaften (EN)

> **This file is for a Studio UI with INVARIANT / ENGLISH separators.**
> Arguments are separated by `,`, multiple statements by `;`.
> If your Power Apps Studio runs in German, use `02_Eigenschaften_DE.md`
> instead.
>
> How to tell: type `If(` in the formula bar. If the hint reads
